...
def main():
    ...
    names = ("showtime", "showtime_cli.py", "showtime_client.py", "showtime_mcp.py", "showtime_version.py", "package.json")
    ...
    assert [reply["id"] for reply in replies] == [1, 2] and all("error" not in reply for reply in replies)
