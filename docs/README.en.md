...
- **Device frames** — Choose iPhone 16 Pro / Pro Max, iPad Pro 11 / 13-inch, or MacBook Neo and MacBook Pro frames redrawn from the 2026 designs, with None as the default. Light uses silver; Dark uses indigo on Neo and space black on other devices. Frames define screen proportions and appearance, with complete, uninterrupted laptop screens. Web content and hardware render at the Export resolution, including 4K.
